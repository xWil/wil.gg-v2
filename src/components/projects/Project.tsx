...
function Project({ header, description, details, link }: ProjectProps) {
    return (
        <div className="min-h-screen w-full pb-16 pt-32 px-8 md:px-8 lg:px-16 xl:px-24 flex flex-col items-center justify-center">
